This will allow you to match two datasets based on names of varying spellings and styles (ex: one dataset reads "Phil R. Smith" and one reads "Phil Smith") along with date of birth in order to merge two datasets together. 
